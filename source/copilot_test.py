...
# Add more grid placements for buttons here...

button_add.grid(row=1, column=3)
button_subtract.grid(row=2, column=3)
# Add more grid placements for operator buttons here...

button_clear.grid(row=3, column=3)
button_equal.grid(row=4, column=1)
# Add more grid placements for other buttons here...
